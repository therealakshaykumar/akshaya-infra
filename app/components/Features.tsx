...
export default function Features() {
  return (
    <section className="flex flex-col w-full bg-[#f4f6f9] overflow-hidden mb-[0.9px]">
      ...
      {/* Top Header Bar */}
      <div className="relative bg-[#0F2A55]/90 w-full py-12 px-6 flex justify-center items-center overflow-hidden shadow-md">
        {/* Subtle background image overlay for the header */}
        <div className="absolute inset-0 z-0 opacity-30 mix-blend-overlay">
          <Image src="/bg.jpg" alt="Header Background" fill className="object-cover object-center" />
        </div>
        ...
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="relative z-10 text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-wide text-center"
        ...
        >
          <Image 
            ...
            width={120} 
            height={120} 
            className="w-24 md:w-28 drop-shadow-xl" 
          />
        </motion.div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
          {features.map((feat, idx) => (
            <motion.div
              ...
              className="flex w-full overflow-hidden rounded-2xl border-2 border-[#0F2A55] bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300"
            >
      ...
      {/* Bottom Footer Bar */}
      <div className="bg-[#0F2A55] w-full py-4 flex justify-center items-center shadow-inner mt-auto">
